...
_singa_wrap.USE_CUDA_swigconstant(_singa_wrap)
USE_CUDA = _singa_wrap.USE_CUDA

_singa_wrap.USE_CUDNN_swigconstant(_singa_wrap)
USE_CUDNN = _singa_wrap.USE_CUDNN

_singa_wrap.USE_OPENCL_swigconstant(_singa_wrap)
USE_OPENCL = _singa_wrap.USE_OPENCL

_singa_wrap.USE_PYTHON_swigconstant(_singa_wrap)
USE_PYTHON = _singa_wrap.USE_PYTHON

_singa_wrap.USE_JAVA_swigconstant(_singa_wrap)
USE_JAVA = _singa_wrap.USE_JAVA

_singa_wrap.SINGA_MAJOR_VERSION_swigconstant(_singa_wrap)
SINGA_MAJOR_VERSION = _singa_wrap.SINGA_MAJOR_VERSION

_singa_wrap.SINGA_MINOR_VERSION_swigconstant(_singa_wrap)
SINGA_MINOR_VERSION = _singa_wrap.SINGA_MINOR_VERSION

_singa_wrap.SINGA_PATCH_VERSION_swigconstant(_singa_wrap)
SINGA_PATCH_VERSION = _singa_wrap.SINGA_PATCH_VERSION

_singa_wrap.SINGA_VERSION_swigconstant(_singa_wrap)
...
_singa_wrap.SHARED_PTR_DISOWN_swigconstant(_singa_wrap)
...
_singa_wrap.kFloat32_swigconstant(_singa_wrap)
kFloat32 = _singa_wrap.kFloat32

_singa_wrap.kFloat16_swigconstant(_singa_wrap)
kFloat16 = _singa_wrap.kFloat16

_singa_wrap.kInt_swigconstant(_singa_wrap)
kInt = _singa_wrap.kInt

_singa_wrap.kChar_swigconstant(_singa_wrap)
kChar = _singa_wrap.kChar

_singa_wrap.kDouble_swigconstant(_singa_wrap)
...
class Platform(_object):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["GetDefaultDevice"] = lambda x: _singa_wrap.Platform_GetDefaultDevice
    if _newclass:
...
class ConvHandle(_object):
    ...
    def __init__(self, input, kernel_size, stride, padding, in_channels, out_channels, bias):
        this = _singa_wrap.new_ConvHandle(input, kernel_size, stride, padding, in_channels, out_channels, bias)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
