...
class Conv2d(Operation):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=3, stride=1,
        ...
        self.param = {'in_features': in_features, 'out_features': out_features, 'name': 'Conv2d',
...
class Linear(Operation):
    ...
    def __init__(self, in_features, out_features, bias=True):
        self.param={'in_features':in_features,'out_features':out_features,'name':'linear'}
...
class MaxPool2d(Operation):
    ...
    def __init__(self, kernel_size=3, stride=1, padding=0, dilation=1,
        ...
        self.param={'kernel_size':3, 'stride':1, 'padding':0, 'dilation':1,'name':'maxpool2d'}
